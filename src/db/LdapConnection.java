...
public class LdapConnection {
	...
	/**
	 * Search an entry in LDAP using Novell API.
	 *
	 * @param dirContext
	 * @param searchFilter
	 * @param searchBase
	 ...
	 * @throws NamingException
	 */
	private static void displayAttributes(final Attributes attributes)
			throws NamingException {
...
//					System.out.println("\t		= " + namingEnu.next());
	...
	/**
	 * Main, entry point for e.g. testing.
	 *
	 * @param args Parameters given e.g. per command line.
	 */
...
//			LdapConnection.getSearchResult(ctx, "objectClass=*", "ou=people,o=uni-wuerzburg");
			...
			System.out.println("LDAP failure");
		}
