...
*/
public final class CRC32Checksum  extends ChecksumGeneratorBase 
{
    private static /* [UNSUPPORTED] 'extern' modifier not supported */ uint crc32(uint crc, int data, uint length) throws Exception ;

    /**
    * Initializes a new instance of the CRC32 checksum generator
    */
    public CRC32Checksum() throws Exception {
        super();
    }
    ...
    */
    public CRC32Checksum(uint initialValue) throws Exception {
        super(initialValue);
    }
