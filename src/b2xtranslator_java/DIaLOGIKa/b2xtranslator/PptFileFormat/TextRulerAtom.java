...
public class TextRulerAtom  extends DIaLOGIKa.b2xtranslator.OfficeDrawing.Record 
{
    public uint flags;
    ...
    public int indent4;
    public int indent5;
    public TextRulerAtom(BinaryReader _reader, uint size, uint typeCode, uint version, uint instance) throws Exception {
