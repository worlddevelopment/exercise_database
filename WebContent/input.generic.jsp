<%
String type = "text"; // <- The default type (text) it is tested and working.
...
if (request.getParameter("default") != null) {
	...
	out.println(
		"<input type='hidden' name='" + varname_old + "' "
		+ " value='" + init + "'  id='"
		+ (request.getParameter("id") != null ? request.getParameter("id") : "")
		+ "'"
		+ " onfocus='"+ request.getParameter("onfocus") + "'"
		+ " onkeyup='"+ request.getParameter("onkeyup") + "'/>"
	);
}
%>
