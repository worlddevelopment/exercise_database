<%@page import="java.util.*, java.text.*,
        aufgaben_db.*,aufgaben_db.DocType,
        java.net.URLDecoder,
        java.sql.ResultSet;" %>
<%
...
<form class="cmxform" id="commentForm" method="post"  action="index.jsp?id=edit&q=edit_sheet#add_result">
   ...
   -->
   <p class="auto-style1 screenshot">Blatt editieren:
        ...
        <tr>
            ...
            <td>
                <jsp:include page="input.course.jsp">
                    ...
                    <jsp:param name="node_id" value="course_edit"></jsp:param>
                </jsp:include>
            </td>
        ...
        <tr>
            ...
            <td>
                <jsp:include page="input.type.jsp">
                    <jsp:param name="default" value="<%=type %>"></jsp:param>
                </jsp:include>
            </td>
        </tr>
        

        <!-- LECTURER ID (html id different because otherwise a DOM conflict with upload overlay occurs) -->
        <tr>
