...
<%
    ...
    try {
        ...
        /*IMPORTANT: From here only always use sheetdraft.getFilelink !! as it have
        ...
        */
        ...
        //The link is now being created on the fly, so it's no longer a question.
...
//                  )
        ...
        */
        ...
        if (!Global.sqlm.exist("sheetdraft", "filelink", column_value)) {
            ...
            message = "<!-- centered fixed message wrapper --><div id='summary' class='info centered fixed' onclick=''>"//also allow for ?
