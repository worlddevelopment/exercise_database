...
<%@ page import="java.util.Properties,javax.naming.Context,
 ...
 env.put(Context.PROVIDER_URL, "ldaps://auth.uni-wuerzburg.de:636/");
 //ldap://adressbuch.uni-wuerzburg.de:389/ou=people,o=uni-wuerzburg??one?(objectClass=*)
 env.put(Context.SECURITY_PROTOCOL, "ssl");
 //env.put(Context.REFERRAL, "follow");
 env.put(Context.SECURITY_AUTHENTICATION, "simple");
 env.put(Context.SECURITY_PRINCIPAL, "cn=username,ou=accounts,o=uni-wuerzburg");
...
public String getSearchResult(HttpServletResponse resp, final DirContext dirContext,
...
public String displayAttributes(HttpServletResponse resp, final Attributes attributes)
		throws IOException,NamingException {
	String erg ="";
	PrintWriter out = resp.getWriter();
	if (attributes == null) {
